...
def main():
    threshold_high_gb = 8.0  # 6GB
    threshold_low_gb = 6.0   # 4GB
    ...
    while True:
        ...
        if used_memory_gb > threshold_high_gb and current_power_plan != high_performance_plan_guid:
            print("O uso de memória excedeu 8GB, alternando para o plano de energia: Alto desempenho.")
            ...
            print("O uso de memória excedeu 6GB, alternando para o plano de energia: Equilibrado.")
            ...
            print("O uso de memória está abaixo de 6GB, alternando para o plano de energia: Economia de energia.")
